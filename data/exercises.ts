...
export const EXERCISES: Exercise[] = [
  ...
  { id: "ex_002", name: "Bulgarian split squat", category: "major", bodyParts: ["upper-leg"], preference: 3 },
  { id: "ex_003", name: "One-arm row", category: "major", bodyParts: ["back", "arms"], preference: 3 },
  { id: "ex_004", name: "Dumbbell fly", category: "major", bodyParts: ["chest", "shoulders"], preference: 3 },
  { id: "ex_005", name: "Dumbbell pullover", category: "major", bodyParts: ["chest", "back"], preference: 3 },
  { id: "ex_006", name: "Skullcrusher", category: "major", bodyParts: ["arms"], preference: 3 },
  { id: "ex_007", name: "Hammer curl", category: "major", bodyParts: ["arms"], preference: 3 },
  { id: "ex_008", name: "Kettlebell swings", category: "major", bodyParts: ["upper-leg", "back", "core"], preference: 3 },
  { id: "ex_009", name: "Calf raise", category: "major", bodyParts: ["lower-leg"], preference: 3 },
  { id: "ex_010", name: "Shrug", category: "major", bodyParts: ["shoulders", "back"], preference: 3 },
  { id: "ex_011", name: "Shoulder raise", category: "major", bodyParts: ["shoulders"], preference: 3 },

  // ── Minor strength ─────────────────────────────────────────────────────────
  { id: "ex_012", name: "Svend press", category: "minor", bodyParts: ["chest", "shoulders"], preference: 3 },
  { id: "ex_013", name: "Front raise", category: "minor", bodyParts: ["shoulders"], preference: 3 },
  { id: "ex_014", name: "Side raise", category: "minor", bodyParts: ["shoulders"], preference: 3 },
  { id: "ex_015", name: "Scapula press", category: "minor", bodyParts: ["shoulders", "back"], preference: 3 },
  { id: "ex_016", name: "Rotator cuff", category: "minor", bodyParts: ["shoulders"], preference: 3 },
  { id: "ex_017", name: "Seated Russian twist", category: "minor", bodyParts: ["core"], preference: 3 },
  { id: "ex_018", name: "Raised heel lunge", category: "minor", bodyParts: ["upper-leg"], preference: 3 },
  { id: "ex_019", name: "Wrist curl", category: "minor", bodyParts: ["arms"], preference: 3 },
  { id: "ex_020", name: "Single leg RDL", category: "minor", bodyParts: ["upper-leg", "back"], preference: 3 },
  { id: "ex_021", name: "Standing hip rotation aeroplanes", category: "minor", bodyParts: ["upper-leg", "core"], preference: 3 },
  { id: "ex_022", name: "Curtsey squat", category: "minor", bodyParts: ["upper-leg"], preference: 3 },
  { id: "ex_023", name: "Extended lunge", category: "minor", bodyParts: ["upper-leg"], preference: 3 },
  { id: "ex_024", name: "Prone TYI", category: "minor", bodyParts: ["shoulders", "back"], preference: 3 },
  { id: "ex_025", name: "Clam", category: "minor", bodyParts: ["upper-leg"], preference: 3 },
  ...
  { id: "ex_029", name: "Bench pigeon raise", category: "minor", bodyParts: ["upper-leg"], preference: 3 },
  { id: "ex_030", name: "Hip rotator", category: "minor", bodyParts: ["upper-leg"], preference: 3 },

  // ── Dynamic stretches ──────────────────────────────────────────────────────
  { id: "ex_031", name: "Good morning", category: "dynamic", bodyParts: ["back", "upper-leg"], preference: 3 },
  { id: "ex_032", name: "Rolling knees", category: "dynamic", bodyParts: ["upper-leg"], preference: 3 },
  { id: "ex_033", name: "Thread the needle", category: "dynamic", bodyParts: ["back", "shoulders"], preference: 3 },
  ...
  { id: "ex_036", name: "Alternating cossack squats", category: "dynamic", bodyParts: ["upper-leg"], preference: 3 },
  { id: "ex_037", name: "Frog squat", category: "dynamic", bodyParts: ["upper-leg"], preference: 3 },
  { id: "ex_038", name: "1-2-5 ankle flexion", category: "dynamic", bodyParts: ["lower-leg"], preference: 3 },
  { id: "ex_039", name: "Forward-back ankle flexion", category: "dynamic", bodyParts: ["lower-leg"], preference: 3 },
  ...
  { id: "ex_050", name: "Ankle mobility heel raise", category: "mobilisation", bodyParts: ["lower-leg"], preference: 3 },
  { id: "ex_051", name: "End-range hip flexion", category: "mobilisation", bodyParts: ["upper-leg"], preference: 3 },
